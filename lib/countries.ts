// List of countries with their ISO 3166-1 alpha-2 code, French display
// name and international dial code. Used on signup (and when an admin
// adds a team member) to let the user pick their country, which both
// fills the `country` field and prefixes the phone number with the
// right dial code — see composeInternationalPhone() in ./phone.
export type Country = {
